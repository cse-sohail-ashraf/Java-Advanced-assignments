package com.capgemini.hibernateOneToMany;
...
public class App {
	public static void main(String[] args) {
		...
		try {
			...
			// CREATE Customer and associate accounts
			Customer customer2 = new Customer("Mark", Arrays.asList(acc1, acc2));
			em.persist(customer1);
			...
			// CREATE Customer and associate accounts
			Customer customer3 = new Customer("Miller", Arrays.asList(acc1, acc2));
			em.persist(customer1);
